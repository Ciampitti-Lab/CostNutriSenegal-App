...
output$precipitationValue <- renderUI({
  ...
  sliderTextInput(inputId = "precipitationAmount",
              label = h4("Precipitation amount (mm):"),
...
# Select for Variable -----
output$selectVariablePlot <- renderUI({
...
uiOutput(outputId = "selectVariablePlot")
...
output$radioButton <- renderUI({
   ...
   if(input$precipitationOrAlternative == "alternativeManagements"){
...
seedCost <- reactive({
  ...
  else if(input$precipitationOrAlternative == "precipitation"){
