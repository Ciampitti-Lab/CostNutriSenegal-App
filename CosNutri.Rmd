...
shinyWidgets::pickerInput(inputId = "scenarioSelection",
                          label = "Select an alternative scenario to show on cards:",
                          choices = c(1, 2, 3, 4, 5),
                          multiple = FALSE,
                          inline = TRUE,
                          width = "fit"
...
flexdashboard::renderValueBox({
  ...
  flexdashboard::valueBox(value = h1((paste(round(seedCost()), "?"))),
...
flexdashboard::renderValueBox({
  ...
  flexdashboard::valueBox(value = h1((paste(round(NCost()), "?"))),
...
flexdashboard::renderValueBox({
  ...
  flexdashboard::valueBox(value = h2((paste(round(KCalperperson()), "KCal"))),
                          caption = paste("<h4>KCal per person per day</h4>",
                                          sep =""),
                          color = ifelse(round(KCalperperson(), digits=1) > 2303.6 , "success",
                                         ifelse(round(KCalperperson(), digits=1) < 1740.5, "danger",
                                                "warning")),
                          icon = "fa-chart-pyramid")
})
...
flexdashboard::renderValueBox({
  ...
  flexdashboard::valueBox(value = h1((paste(round(totalCost()), "?"))),
...
flexdashboard::renderValueBox({
  ...
  flexdashboard::valueBox(value = h2(paste(round(netCashIncome()), "FCFA")),
                          caption = paste("<h4>Net cash income <small style = 'color:white'>(x1000)</small></h4>",
                                          sep =""),
